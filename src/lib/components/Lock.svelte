  ...
  $: if (
    ...
    if ($signerAddress && config) {
      switchNetwork(config, { chainId: $selectedCyToken.chainId }).catch(
        (error) => {
          console.warn(
            `Failed to switch wallet network to ${$selectedCyToken.chainId}:`,
            error,
          );
        },
      );
...
<Card size="lg">
  ...
  >
    ...
    <div class="flex w-full flex-col items-center gap-2 sm:hidden">
      ...
      <div
        class="flex w-1/4 flex-col items-center justify-center text-center text-white"
      >
...
>
  <div class="p-1 text-center sm:p-4">
    ...
    <p class="mb-4 text-sm text-gray-700 dark:text-gray-300">
      Before you lock your {$selectedCyToken.underlyingSymbol}, make sure you
    ...
    >
      ...
      <li class="relative pl-2">
        <span class="absolute -left-4">•</span>
        Smart contracts are immutable and cannot be upgraded or modified. Cyclo has
        been audited, however this does not guarantee there are no bugs or other
        vulnerabilities.
      </li>
      <li class="relative pl-2">
        <span class="absolute -left-4">•</span>
      ...
      <li class="relative pl-2">
        <span class="absolute -left-4">•</span>
        Cyclo relies on oracles to determine the ${$selectedCyToken.underlyingSymbol}/USD
        price. These are maintained by providers on {$selectedCyToken.networkName}.
      </li>
      <li class="relative pl-2">
        <span class="absolute -left-4">•</span>
    ...
    <p class="mb-4 text-sm text-gray-700 dark:text-gray-300">
      For more information on risks, please see the <a
        href={base + "/docs/risks"}>Risks</a
