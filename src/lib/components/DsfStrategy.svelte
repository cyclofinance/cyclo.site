			...
			<div class="flex flex-col gap-6">
				...
				<div class="flex flex-col gap-2">
					<span class="text-sm text-gray-200">
						Next Trade Multiplier
						<InfoTooltip
							>This is the most the order will move the price in a single trade. Larger numbers will
							capture larger price jumps but trade less often, smaller numbers will trade more often
							but be less defensive against large price jumps in the market.
						</InfoTooltip>
					</span>
					<Input
						type="number"
				...
				<div class="flex flex-col gap-2">
					<span class="text-sm text-gray-200">
						Cost Basis Multiplier
						<InfoTooltip
							>The minimum spread applied to the breakeven in addition to the auction. This is
							applied in both directions so 1.01x would be a 2% total spread.
						</InfoTooltip>
					</span>
					<Input
						type="number"
				...
				<div class="flex flex-col gap-2">
					<span class="text-sm text-gray-200">
						Time Per Epoch
						<InfoTooltip
							>The amount of time (in seconds) between halvings of the price and the amount offered
							during each auction, relative to their baselines.
						</InfoTooltip>
					</span>
					<Input
						type="number"
